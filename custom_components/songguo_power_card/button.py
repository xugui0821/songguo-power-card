...
BUTTONS: tuple[SongguoButtonDescription, ...] = (
    ...
    SongguoButtonDescription("restart", "restart", 25, ButtonDeviceClass.RESTART),
    SongguoButtonDescription("force_power_off", "force_power_off", 14),
    SongguoButtonDescription("force_restart", "force_restart", 2, ButtonDeviceClass.RESTART),
)
